        ...
        cmd := &serpent.Command{
                ...
                Handler: func(inv *serpent.Invocation) error {
                        var (
                                ...
                                // Use appropriate script set based on OS
                                installScriptSet = unixScriptSet
                                if runtime.GOOS == "windows" {
                                        installScriptSet = windowsScriptSet
                                }
                        )
                        ...
                        if script != "" {
                                ...
                                // Skip execute permission check for PowerShell scripts on Windows
