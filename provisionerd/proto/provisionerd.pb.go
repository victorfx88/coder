...
type AcquiredJob struct {
	...
	//	*AcquiredJob_ResourcePoolEntryBuild_
...
func (x *AcquiredJob) GetResourcePoolEntryBuild() *AcquiredJob_ResourcePoolEntryBuild {
	if x, ok := x.GetType().(*AcquiredJob_ResourcePoolEntryBuild_); ok {
		return x.ResourcePoolEntryBuild
	}
	return nil
}
...
type AcquiredJob_ResourcePoolEntryBuild_ struct {
	ResourcePoolEntryBuild *AcquiredJob_ResourcePoolEntryBuild `protobuf:"bytes,10,opt,name=resource_pool_entry_build,json=resourcePoolEntryBuild,proto3,oneof"`
}
...
func (*AcquiredJob_ResourcePoolEntryBuild_) isAcquiredJob_Type() {}
...
type FailedJob struct {
	...
	//	*FailedJob_ResourcePoolEntryBuild_
...
func (x *FailedJob) GetResourcePoolEntryBuild() *FailedJob_ResourcePoolEntryBuild {
	if x, ok := x.GetType().(*FailedJob_ResourcePoolEntryBuild_); ok {
		return x.ResourcePoolEntryBuild
	}
	return nil
}
...
type FailedJob_ResourcePoolEntryBuild_ struct {
	ResourcePoolEntryBuild *FailedJob_ResourcePoolEntryBuild `protobuf:"bytes,7,opt,name=resource_pool_entry_build,json=resourcePoolEntryBuild,proto3,oneof"`
}
...
func (*FailedJob_ResourcePoolEntryBuild_) isFailedJob_Type() {}
...
type CompletedJob struct {
	...
	//	*CompletedJob_ResourcePoolEntryBuild_
...
func (x *CompletedJob) GetResourcePoolEntryBuild() *CompletedJob_ResourcePoolEntryBuild {
	if x, ok := x.GetType().(*CompletedJob_ResourcePoolEntryBuild_); ok {
		return x.ResourcePoolEntryBuild
	}
	return nil
}
...
type CompletedJob_ResourcePoolEntryBuild_ struct {
	ResourcePoolEntryBuild *CompletedJob_ResourcePoolEntryBuild `protobuf:"bytes,5,opt,name=resource_pool_entry_build,json=resourcePoolEntryBuild,proto3,oneof"`
}
...
func (*CompletedJob_ResourcePoolEntryBuild_) isCompletedJob_Type() {}
...
type AcquiredJob_ResourcePoolEntryBuild struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Metadata *proto.ResourcePoolEntryMetadata `protobuf:"bytes,2,opt,name=metadata,proto3" json:"metadata,omitempty"`
}

func (x *AcquiredJob_ResourcePoolEntryBuild) Reset() {
	*x = AcquiredJob_ResourcePoolEntryBuild{}
	if protoimpl.UnsafeEnabled {
...
func (x *AcquiredJob_ResourcePoolEntryBuild) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AcquiredJob_ResourcePoolEntryBuild) ProtoMessage() {}

func (x *AcquiredJob_ResourcePoolEntryBuild) ProtoReflect() protoreflect.Message {
	mi := &file_provisionerd_proto_provisionerd_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AcquiredJob_ResourcePoolEntryBuild.ProtoReflect.Descriptor instead.
func (*AcquiredJob_ResourcePoolEntryBuild) Descriptor() ([]byte, []int) {
	return file_provisionerd_proto_provisionerd_proto_rawDescGZIP(), []int{1, 3}
}

func (x *AcquiredJob_ResourcePoolEntryBuild) GetMetadata() *proto.ResourcePoolEntryMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type FailedJob_ResourcePoolEntryBuild struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	State   []byte          `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`
	Timings []*proto.Timing `protobuf:"bytes,2,rep,name=timings,proto3" json:"timings,omitempty"` // TODO: for later
}

func (x *FailedJob_ResourcePoolEntryBuild) Reset() {
	*x = FailedJob_ResourcePoolEntryBuild{}
	if protoimpl.UnsafeEnabled {
...
func (x *FailedJob_ResourcePoolEntryBuild) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FailedJob_ResourcePoolEntryBuild) ProtoMessage() {}

func (x *FailedJob_ResourcePoolEntryBuild) ProtoReflect() protoreflect.Message {
	mi := &file_provisionerd_proto_provisionerd_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FailedJob_ResourcePoolEntryBuild.ProtoReflect.Descriptor instead.
func (*FailedJob_ResourcePoolEntryBuild) Descriptor() ([]byte, []int) {
	return file_provisionerd_proto_provisionerd_proto_rawDescGZIP(), []int{2, 3}
}

func (x *FailedJob_ResourcePoolEntryBuild) GetState() []byte {
	if x != nil {
		return x.State
	}
	return nil
...
func (x *FailedJob_ResourcePoolEntryBuild) GetTimings() []*proto.Timing {
	if x != nil {
		return x.Timings
	}
	return nil
...
type CompletedJob_WorkspaceBuild struct {
	...
	ResourcePoolClaims []*proto.ResourcePoolClaim `protobuf:"bytes,5,rep,name=resource_pool_claims,json=resourcePoolClaims,proto3" json:"resource_pool_claims,omitempty"`
}
...
func (x *CompletedJob_WorkspaceBuild) GetResourcePoolClaims() []*proto.ResourcePoolClaim {
	if x != nil {
...
type CompletedJob_TemplateImport struct {
	...
	ResourcePoolClaims         []*proto.ResourcePoolClaim            `protobuf:"bytes,8,rep,name=resource_pool_claims,json=resourcePoolClaims,proto3" json:"resource_pool_claims,omitempty"`
}
...
func (x *CompletedJob_TemplateImport) GetResourcePoolClaims() []*proto.ResourcePoolClaim {
	if x != nil {
		return x.ResourcePoolClaims
	}
	return nil
...
type CompletedJob_TemplateDryRun struct {
	...
	ResourcePoolClaims []*proto.ResourcePoolClaim `protobuf:"bytes,3,rep,name=resource_pool_claims,json=resourcePoolClaims,proto3" json:"resource_pool_claims,omitempty"`
}
...
func (x *CompletedJob_TemplateDryRun) GetResourcePoolClaims() []*proto.ResourcePoolClaim {
	if x != nil {
		return x.ResourcePoolClaims
	}
	return nil
...
type CompletedJob_ResourcePoolEntryBuild struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	State                  []byte                         `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`
	Resources              []*proto.Resource              `protobuf:"bytes,2,rep,name=resources,proto3" json:"resources,omitempty"`
	ResourcePoolClaimables []*proto.ResourcePoolClaimable `protobuf:"bytes,3,rep,name=resource_pool_claimables,json=resourcePoolClaimables,proto3" json:"resource_pool_claimables,omitempty"`
}

func (x *CompletedJob_ResourcePoolEntryBuild) Reset() {
	*x = CompletedJob_ResourcePoolEntryBuild{}
	if protoimpl.UnsafeEnabled {
...
func (x *CompletedJob_ResourcePoolEntryBuild) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompletedJob_ResourcePoolEntryBuild) ProtoMessage() {}

func (x *CompletedJob_ResourcePoolEntryBuild) ProtoReflect() protoreflect.Message {
	mi := &file_provisionerd_proto_provisionerd_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompletedJob_ResourcePoolEntryBuild.ProtoReflect.Descriptor instead.
func (*CompletedJob_ResourcePoolEntryBuild) Descriptor() ([]byte, []int) {
	return file_provisionerd_proto_provisionerd_proto_rawDescGZIP(), []int{3, 3}
}

func (x *CompletedJob_ResourcePoolEntryBuild) GetState() []byte {
	if x != nil {
		return x.State
	}
	return nil
...
func (x *CompletedJob_ResourcePoolEntryBuild) GetResources() []*proto.Resource {
	if x != nil {
		return x.Resources
	}
	return nil
...
func (x *CompletedJob_ResourcePoolEntryBuild) GetResourcePoolClaimables() []*proto.ResourcePoolClaimable {
	if x != nil {
...
var file_provisionerd_proto_provisionerd_proto_rawDesc = []byte{
	...
	0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0xef, 0x0c, 0x0a, 0x0b, 0x41, 0x63, 0x71, 0x75, 0x69,
	...
	,
	...
	0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x12, 0x25, 0x0a, 0x0e, 0x77, 0x6f, 0x72, 0x6b,
	...
	0x72, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f,
	...
	0x64, 0x65, 0x72, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x64, 0x65, 0x72, 0x73, 0x12, 0x31, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1b, 0x0a,
	0x09, 0x6c, 0x6f, 0x67, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x6c, 0x6f, 0x67, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04,
	0x1a, 0x91, 0x01, 0x0a, 0x0e, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x49, 0x6d, 0x70,
	0x6f, 0x72, 0x74, 0x12, 0x31, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18,
	...
	0x6c, 0x75, 0x65, 0x73, 0x1a, 0xe3, 0x01, 0x0a, 0x0e, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	...
	0x73, 0x12, 0x31, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20,
	...
	0x64, 0x61, 0x74, 0x61, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x1a, 0x62, 0x0a, 0x16, 0x52, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x6f, 0x6f, 0x6c, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x42,
	0x75, 0x69, 0x6c, 0x64, 0x12, 0x42, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69,
	0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x6f, 0x6f,
	0x6c, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x08,
	...
	0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xa0, 0x05, 0x0a, 0x09, 0x46, 0x61, 0x69,
	...
	,
	...
	0x79, 0x52, 0x75, 0x6e, 0x1a, 0x5d, 0x0a, 0x16, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x50, 0x6f, 0x6f, 0x6c, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x12, 0x14,
	...
	0x6e, 0x67, 0x73, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xfb, 0x0c, 0x0a, 0x0c,
	...
	,
	...
	0x65, 0x73, 0x12, 0x50, 0x0a, 0x14, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x70,
	...
	0x61, 0x69, 0x6d, 0x73, 0x1a, 0xbd, 0x04, 0x0a, 0x0e, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	...
	,
	...
	,
	...
	0x63, 0x65, 0x73, 0x12, 0x5c, 0x0a, 0x18, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f,
	0x6e, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x6f, 0x6f, 0x6c,
	0x43, 0x6c, 0x61, 0x69, 0x6d, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x16, 0x72, 0x65, 0x73, 0x6f, 0x75,
...
var file_provisionerd_proto_provisionerd_proto_goTypes = []interface{}{
	...
	(*AcquiredJob_ResourcePoolEntryBuild)(nil), // 14: provisionerd.AcquiredJob.ResourcePoolEntryBuild
	...
	(*FailedJob_ResourcePoolEntryBuild)(nil),    // 19: provisionerd.FailedJob.ResourcePoolEntryBuild
	...
	(*CompletedJob_ResourcePoolEntryBuild)(nil), // 23: provisionerd.CompletedJob.ResourcePoolEntryBuild
	...
	(*proto.ResourcePoolEntryMetadata)(nil),    // 31: provisioner.ResourcePoolEntryMetadata
	(*proto.Timing)(nil),                       // 32: provisioner.Timing
	(*proto.Resource)(nil),                     // 33: provisioner.Resource
	(*proto.Module)(nil),                       // 34: provisioner.Module
	(*proto.ResourcePoolClaim)(nil),            // 35: provisioner.ResourcePoolClaim
	...
	(*proto.ResourcePoolClaimable)(nil),        // 38: provisioner.ResourcePoolClaimable
}
var file_provisionerd_proto_provisionerd_proto_depIdxs = []int32{
	...
	14, // 3: provisionerd.AcquiredJob.resource_pool_entry_build:type_name -> provisionerd.AcquiredJob.ResourcePoolEntryBuild
	15, // 4: provisionerd.AcquiredJob.trace_metadata:type_name -> provisionerd.AcquiredJob.TraceMetadataEntry
	16, // 5: provisionerd.FailedJob.workspace_build:type_name -> provisionerd.FailedJob.WorkspaceBuild
	17, // 6: provisionerd.FailedJob.template_import:type_name -> provisionerd.FailedJob.TemplateImport
	18, // 7: provisionerd.FailedJob.template_dry_run:type_name -> provisionerd.FailedJob.TemplateDryRun
	19, // 8: provisionerd.FailedJob.resource_pool_entry_build:type_name -> provisionerd.FailedJob.ResourcePoolEntryBuild
	20, // 9: provisionerd.CompletedJob.workspace_build:type_name -> provisionerd.CompletedJob.WorkspaceBuild
	21, // 10: provisionerd.CompletedJob.template_import:type_name -> provisionerd.CompletedJob.TemplateImport
	22, // 11: provisionerd.CompletedJob.template_dry_run:type_name -> provisionerd.CompletedJob.TemplateDryRun
	23, // 12: provisionerd.CompletedJob.resource_pool_entry_build:type_name -> provisionerd.CompletedJob.ResourcePoolEntryBuild
	0,  // 13: provisionerd.Log.source:type_name -> provisionerd.LogSource
	25, // 14: provisionerd.Log.level:type_name -> provisioner.LogLevel
	5,  // 15: provisionerd.UpdateJobRequest.logs:type_name -> provisionerd.Log
	26, // 16: provisionerd.UpdateJobRequest.template_variables:type_name -> provisioner.TemplateVariable
	27, // 17: provisionerd.UpdateJobRequest.user_variable_values:type_name -> provisioner.VariableValue
	24, // 18: provisionerd.UpdateJobRequest.workspace_tags:type_name -> provisionerd.UpdateJobRequest.WorkspaceTagsEntry
	27, // 19: provisionerd.UpdateJobResponse.variable_values:type_name -> provisioner.VariableValue
	28, // 20: provisionerd.AcquiredJob.WorkspaceBuild.rich_parameter_values:type_name -> provisioner.RichParameterValue
	27, // 21: provisionerd.AcquiredJob.WorkspaceBuild.variable_values:type_name -> provisioner.VariableValue
	29, // 22: provisionerd.AcquiredJob.WorkspaceBuild.external_auth_providers:type_name -> provisioner.ExternalAuthProvider
	30, // 23: provisionerd.AcquiredJob.WorkspaceBuild.metadata:type_name -> provisioner.Metadata
	30, // 24: provisionerd.AcquiredJob.TemplateImport.metadata:type_name -> provisioner.Metadata
	27, // 25: provisionerd.AcquiredJob.TemplateImport.user_variable_values:type_name -> provisioner.VariableValue
	28, // 26: provisionerd.AcquiredJob.TemplateDryRun.rich_parameter_values:type_name -> provisioner.RichParameterValue
	27, // 27: provisionerd.AcquiredJob.TemplateDryRun.variable_values:type_name -> provisioner.VariableValue
	30, // 28: provisionerd.AcquiredJob.TemplateDryRun.metadata:type_name -> provisioner.Metadata
	31, // 29: provisionerd.AcquiredJob.ResourcePoolEntryBuild.metadata:type_name -> provisioner.ResourcePoolEntryMetadata
	32, // 30: provisionerd.FailedJob.WorkspaceBuild.timings:type_name -> provisioner.Timing
	32, // 31: provisionerd.FailedJob.ResourcePoolEntryBuild.timings:type_name -> provisioner.Timing
	...
	35, // 35: provisionerd.CompletedJob.WorkspaceBuild.resource_pool_claims:type_name -> provisioner.ResourcePoolClaim
	...
	35, // 42: provisionerd.CompletedJob.TemplateImport.resource_pool_claims:type_name -> provisioner.ResourcePoolClaim
	...
	35, // 45: provisionerd.CompletedJob.TemplateDryRun.resource_pool_claims:type_name -> provisioner.ResourcePoolClaim
	33, // 46: provisionerd.CompletedJob.ResourcePoolEntryBuild.resources:type_name -> provisioner.Resource
	38, // 47: provisionerd.CompletedJob.ResourcePoolEntryBuild.resource_pool_claimables:type_name -> provisioner.ResourcePoolClaimable
	1,  // 48: provisionerd.ProvisionerDaemon.AcquireJob:input_type -> provisionerd.Empty
	10, // 49: provisionerd.ProvisionerDaemon.AcquireJobWithCancel:input_type -> provisionerd.CancelAcquire
	8,  // 50: provisionerd.ProvisionerDaemon.CommitQuota:input_type -> provisionerd.CommitQuotaRequest
	6,  // 51: provisionerd.ProvisionerDaemon.UpdateJob:input_type -> provisionerd.UpdateJobRequest
	3,  // 52: provisionerd.ProvisionerDaemon.FailJob:input_type -> provisionerd.FailedJob
	4,  // 53: provisionerd.ProvisionerDaemon.CompleteJob:input_type -> provisionerd.CompletedJob
	2,  // 54: provisionerd.ProvisionerDaemon.AcquireJob:output_type -> provisionerd.AcquiredJob
	2,  // 55: provisionerd.ProvisionerDaemon.AcquireJobWithCancel:output_type -> provisionerd.AcquiredJob
	9,  // 56: provisionerd.ProvisionerDaemon.CommitQuota:output_type -> provisionerd.CommitQuotaResponse
	7,  // 57: provisionerd.ProvisionerDaemon.UpdateJob:output_type -> provisionerd.UpdateJobResponse
	1,  // 58: provisionerd.ProvisionerDaemon.FailJob:output_type -> provisionerd.Empty
	1,  // 59: provisionerd.ProvisionerDaemon.CompleteJob:output_type -> provisionerd.Empty
...
func file_provisionerd_proto_provisionerd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_provisionerd_proto_provisionerd_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AcquiredJob_ResourcePoolEntryBuild); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provisionerd_proto_provisionerd_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FailedJob_ResourcePoolEntryBuild); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provisionerd_proto_provisionerd_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CompletedJob_ResourcePoolEntryBuild); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_provisionerd_proto_provisionerd_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*AcquiredJob_ResourcePoolEntryBuild_)(nil),
	}
	file_provisionerd_proto_provisionerd_proto_msgTypes[2].OneofWrappers = []interface{}{
		...
		(*FailedJob_ResourcePoolEntryBuild_)(nil),
	}
	file_provisionerd_proto_provisionerd_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*CompletedJob_ResourcePoolEntryBuild_)(nil),
	}
	type x struct{}
