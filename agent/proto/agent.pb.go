...
const file_agent_proto_agent_proto_rawDesc = "" +
	"\n" +
	"\x17agent/proto/agent.proto\x12\x0ecoder.agent.v2\x1a\x1btailnet/proto/tailnet.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x94\x06\n" +
	...
	"\tthreshold\x18\x03 \x01(\x05R\tthreshold\"W\n" +
	...
	"\x10ReportConnection\x12'.coder.agent.v2.ReportConnectionRequest\x1a\x16.google.protobuf.EmptyB'Z%github.com/coder/coder/v2/agent/protob\x06proto3"
...
func file_agent_proto_agent_proto_init() {
	...
	file_agent_proto_agent_proto_msgTypes[46].OneofWrappers = []any{}
	type x struct{}
