...
const deleteWorkspaceAgent = `-- name: DeleteWorkspaceAgent :exec
DELETE FROM workspace_agents WHERE id = $1
`

func (q *sqlQuerier) DeleteWorkspaceAgent(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, deleteWorkspaceAgent, id)
	return err
}
...
func (q *sqlQuerier) GetWorkspaceAgentsByParentID(ctx context.Context, parentID uuid.NullUUID) ([]WorkspaceAgent, error) {
