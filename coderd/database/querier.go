...
type sqlcQuerier interface {
	...
	DeleteWorkspaceAgent(ctx context.Context, id uuid.UUID) error
	...
	GetWorkspaceAgentsByParentID(ctx context.Context, parentID uuid.NullUUID) ([]WorkspaceAgent, error)
