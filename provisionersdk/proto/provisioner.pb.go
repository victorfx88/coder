...
func (x *ResourcePoolMetadata) Reset() {
	*x = ResourcePoolMetadata{}
	if protoimpl.UnsafeEnabled {
...
func (x *ResourcePoolMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourcePoolMetadata) ProtoMessage() {}

func (x *ResourcePoolMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_provisionersdk_proto_provisioner_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourcePoolMetadata.ProtoReflect.Descriptor instead.
func (*ResourcePoolMetadata) Descriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{18}
}

func (x *ResourcePoolMetadata) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ResourcePoolMetadata) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ResourcePoolMetadata) GetTransition() ResourcePoolEntryTransition {
	if x != nil {
		return x.Transition
	}
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x22, 0x84, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x6f, 0x6f,
	...
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x6f, 0x6f, 0x6c, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0a, 0x74, 0x72, 0x61,
	0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x8a, 0x01, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x72, 0x73, 0x22, 0xa7, 0x02, 0x0a, 0x0c, 0x50, 0x6c, 0x61, 0x6e, 0x43, 0x6f, 0x6d, 0x70, 0x6c,
	...
	0x69, 0x6e, 0x67, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x69, 0x6e, 0x67, 0x73, 0x22, 0x41, 0x0a, 0x0c,
	...
	0x45, 0x53, 0x54, 0x52, 0x4f, 0x59, 0x10, 0x02, 0x2a, 0x3b, 0x0a, 0x1b, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x50, 0x6f, 0x6f, 0x6c, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0c, 0x0a, 0x08, 0x41, 0x4c, 0x4c, 0x4f, 0x43,
	0x41, 0x54, 0x45, 0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x44, 0x45, 0x41, 0x4c, 0x4c, 0x4f, 0x43,
	0x41, 0x54, 0x45, 0x10, 0x01, 0x2a, 0x35, 0x0a, 0x0b, 0x54, 0x69, 0x6d, 0x69, 0x6e, 0x67, 0x53,
...
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(*ResourcePoolMetadata)(nil),         // 23: provisioner.ResourcePoolMetadata
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	37, // 11: provisioner.Resource.metadata:type_name -> provisioner.Resource.Metadata
	2,  // 12: provisioner.Metadata.workspace_transition:type_name -> provisioner.WorkspaceTransition
	3,  // 13: provisioner.ResourcePoolMetadata.transition:type_name -> provisioner.ResourcePoolEntryTransition
	...
	39, // 29: provisioner.Timing.start:type_name -> google.protobuf.Timestamp
	39, // 30: provisioner.Timing.end:type_name -> google.protobuf.Timestamp
	4,  // 31: provisioner.Timing.state:type_name -> provisioner.TimingState
	24, // 32: provisioner.Request.config:type_name -> provisioner.Config
	25, // 33: provisioner.Request.parse:type_name -> provisioner.ParseRequest
	27, // 34: provisioner.Request.plan:type_name -> provisioner.PlanRequest
	29, // 35: provisioner.Request.apply:type_name -> provisioner.ApplyRequest
	32, // 36: provisioner.Request.cancel:type_name -> provisioner.CancelRequest
	11, // 37: provisioner.Response.log:type_name -> provisioner.Log
	26, // 38: provisioner.Response.parse:type_name -> provisioner.ParseComplete
	28, // 39: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	30, // 40: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	33, // 41: provisioner.Provisioner.Session:input_type -> provisioner.Request
	34, // 42: provisioner.Provisioner.Session:output_type -> provisioner.Response
...
func file_provisionersdk_proto_provisioner_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_provisionersdk_proto_provisioner_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResourcePoolMetadata); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
