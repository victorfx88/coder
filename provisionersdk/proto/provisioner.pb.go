...
type MonitoredComponent int32

const (
	MonitoredComponent_MEMORY MonitoredComponent = 0
	MonitoredComponent_DISK   MonitoredComponent = 1
)

// Enum value maps for MonitoredComponent.
var (
	MonitoredComponent_name = map[int32]string{
		0: "MEMORY",
		1: "DISK",
	}
	MonitoredComponent_value = map[string]int32{
		"MEMORY": 0,
		"DISK":   1,
	}
)

func (x MonitoredComponent) Enum() *MonitoredComponent {
	p := new(MonitoredComponent)
	*p = x
	return p
}

func (x MonitoredComponent) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MonitoredComponent) Descriptor() protoreflect.EnumDescriptor {
	return file_provisionersdk_proto_provisioner_proto_enumTypes[2].Descriptor()
}

func (MonitoredComponent) Type() protoreflect.EnumType {
	return &file_provisionersdk_proto_provisioner_proto_enumTypes[2]
}

func (x MonitoredComponent) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MonitoredComponent.Descriptor instead.
func (MonitoredComponent) EnumDescriptor() ([]byte, []int) {
...
type Agent struct {
	...
	Monitors    []*Monitor   `protobuf:"bytes,24,rep,name=monitors,proto3" json:"monitors,omitempty"`
}
...
func (x *Agent) GetMonitors() []*Monitor {
	if x != nil {
		return x.Monitors
	}
	return nil
...
type Monitor struct {
	...
	Component MonitoredComponent `protobuf:"varint,1,opt,name=component,proto3,enum=provisioner.MonitoredComponent" json:"component,omitempty"`
...
func (x *Monitor) GetComponent() MonitoredComponent {
	if x != nil {
		return x.Component
	}
	return MonitoredComponent_MEMORY
}

func (x *Monitor) GetThreshold() int32 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xd2, 0x07, 0x0a, 0x05, 0x41,
	...
	0x18, 0x17, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x30, 0x0a,
	0x08, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x18, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x14, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x4d, 0x6f,
	0x6e, 0x69, 0x74, 0x6f, 0x72, 0x52, 0x08, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x73, 0x1a,
	...
	0x6e, 0x67, 0x48, 0x65, 0x6c, 0x70, 0x65, 0x72, 0x22, 0x7e, 0x0a, 0x07, 0x4d, 0x6f, 0x6e, 0x69,
	0x74, 0x6f, 0x72, 0x12, 0x3d, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69,
	0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x43, 0x6f,
	...
	0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x22, 0x2f, 0x0a, 0x03, 0x45, 0x6e, 0x76, 0x12,
	...
	0x4c, 0x49, 0x43, 0x10, 0x02, 0x2a, 0x2a, 0x0a, 0x12, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72,
	0x65, 0x64, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x12, 0x0a, 0x0a, 0x06, 0x4d,
	0x45, 0x4d, 0x4f, 0x52, 0x59, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x49, 0x53, 0x4b, 0x10,
	0x01, 0x2a, 0x37, 0x0a, 0x13, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x54, 0x72,
	...
	0x07, 0x44, 0x45, 0x53, 0x54, 0x52, 0x4f, 0x59, 0x10, 0x02, 0x2a, 0x35, 0x0a, 0x0b, 0x54, 0x69,
...
var file_provisionersdk_proto_provisioner_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(MonitoredComponent)(0),              // 2: provisioner.MonitoredComponent
	...
	(*Monitor)(nil),                      // 17: provisioner.Monitor
	...
	(*Module)(nil),                       // 23: provisioner.Module
	(*Metadata)(nil),                     // 24: provisioner.Metadata
	...
	(*Request)(nil),                      // 34: provisioner.Request
	(*Response)(nil),                     // 35: provisioner.Response
	(*Agent_Metadata)(nil),               // 36: provisioner.Agent.Metadata
	nil,                                  // 37: provisioner.Agent.EnvEntry
	(*Resource_Metadata)(nil),            // 38: provisioner.Resource.Metadata
	nil,                                  // 39: provisioner.ParseComplete.WorkspaceTagsEntry
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	37, // 2: provisioner.Agent.env:type_name -> provisioner.Agent.EnvEntry
	20, // 3: provisioner.Agent.apps:type_name -> provisioner.App
	36, // 4: provisioner.Agent.metadata:type_name -> provisioner.Agent.Metadata
	...
	17, // 8: provisioner.Agent.monitors:type_name -> provisioner.Monitor
	2,  // 9: provisioner.Monitor.component:type_name -> provisioner.MonitoredComponent
	...
	15, // 12: provisioner.Resource.agents:type_name -> provisioner.Agent
	38, // 13: provisioner.Resource.metadata:type_name -> provisioner.Resource.Metadata
	3,  // 14: provisioner.Metadata.workspace_transition:type_name -> provisioner.WorkspaceTransition
	6,  // 15: provisioner.ParseComplete.template_variables:type_name -> provisioner.TemplateVariable
	39, // 16: provisioner.ParseComplete.workspace_tags:type_name -> provisioner.ParseComplete.WorkspaceTagsEntry
	24, // 17: provisioner.PlanRequest.metadata:type_name -> provisioner.Metadata
	9,  // 18: provisioner.PlanRequest.rich_parameter_values:type_name -> provisioner.RichParameterValue
	10, // 19: provisioner.PlanRequest.variable_values:type_name -> provisioner.VariableValue
	14, // 20: provisioner.PlanRequest.external_auth_providers:type_name -> provisioner.ExternalAuthProvider
	...
	32, // 24: provisioner.PlanComplete.timings:type_name -> provisioner.Timing
	23, // 25: provisioner.PlanComplete.modules:type_name -> provisioner.Module
	24, // 26: provisioner.ApplyRequest.metadata:type_name -> provisioner.Metadata
	...
	32, // 30: provisioner.ApplyComplete.timings:type_name -> provisioner.Timing
	40, // 31: provisioner.Timing.start:type_name -> google.protobuf.Timestamp
	40, // 32: provisioner.Timing.end:type_name -> google.protobuf.Timestamp
	4,  // 33: provisioner.Timing.state:type_name -> provisioner.TimingState
	25, // 34: provisioner.Request.config:type_name -> provisioner.Config
	26, // 35: provisioner.Request.parse:type_name -> provisioner.ParseRequest
	28, // 36: provisioner.Request.plan:type_name -> provisioner.PlanRequest
	30, // 37: provisioner.Request.apply:type_name -> provisioner.ApplyRequest
	33, // 38: provisioner.Request.cancel:type_name -> provisioner.CancelRequest
	11, // 39: provisioner.Response.log:type_name -> provisioner.Log
	27, // 40: provisioner.Response.parse:type_name -> provisioner.ParseComplete
	29, // 41: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	31, // 42: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	34, // 43: provisioner.Provisioner.Session:input_type -> provisioner.Request
	35, // 44: provisioner.Provisioner.Session:output_type -> provisioner.Response
